...
def my_probe_prompts() -> list[str]:
    ...
    """
    return [
        # Specific fact (DBLP_journals_corr_PolikarpovaYIS16.pdf, page 1)
        "What is the purpose of the LIFTY domain-specific language?",
        # Verbatim quote (DBLP_conf_nips_YangIBPSR21.pdf, page 4)
        "What was the problem formulation described in 'Program Synthesis Guided Reinforcement Learning for Partially Observed Environments'?",
        # Cross-document question (DBLP_conf_vmcai_SinghSXKS14.pdf, DBLP_conf_aplas_Solar-Lezama09.pdf)
        "How does the approach described in 'Modular Synthesis of Sketches Using Models' improve upon the ideas described in 'The Sketching Approach to Program Synthesis'?",
        # Outside the corpus
